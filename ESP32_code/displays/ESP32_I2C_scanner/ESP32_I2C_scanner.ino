// ESP32_I2C_scanner.ino - simple I2C address scanner for ESP32 maker kit version  to detect any connected devices
//  
...
void loop() {
  ...
  for(address = 1; address < 127; address++ ) 
  {
    ...
    // a device did provide an acknowledgement to the address.
