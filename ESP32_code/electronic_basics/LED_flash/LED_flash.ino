/// LED_flash.ino ESP32 maker kit version of LED_flash.py
...
int positive_pin = 14;         //red LED on ESP32 Maker Kit1
...
void loop() {
  ...
  if (printon) {
    Serial.println("blink the LED on/off with a 0.5 second delay");
    printon = false;
  }
