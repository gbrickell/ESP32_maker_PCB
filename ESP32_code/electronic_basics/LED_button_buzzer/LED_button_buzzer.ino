/// LED_button_buzzer.ino ESP32 maker kit version of LED_button_buzzer.py
...
void loop() {
  ...
  if (printon) {
    Serial.println("press the top button (button 1) to buzz & switch the LED on for 5 seconds");
    printon = false;
  }
  ...
  if (digitalRead(switch_pin) == LOW) {
    ...
    beep(5);  // beeps for 5 seconds whilst the LED is on for this time
